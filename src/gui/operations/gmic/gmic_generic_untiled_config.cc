...
PF::GmicGenericUntiledConfigGUI::GmicGenericUntiledConfigGUI( PF::Layer* layer ):
  OperationConfigGUI( layer, "GMIC Generic Untiled"  ),
  updateButton( "Update" )
{
  controlsBox.pack_start( updateButton );

  updateButton.signal_clicked().connect( sigc::mem_fun(this, &GmicGenericUntiledConfigGUI::on_update) );
  
  add_widget( controlsBox );
}

void PF::GmicGenericUntiledConfigGUI::post_init(std::vector<std::string>& columns)
{
...
//          connect( sigc::mem_fun(this, &PF::GmicGmicGenericConfigGUI::on_color_btn_changed) );
    }
      break;
    case arg_type_const:
      break;
...
void PF::GmicGenericUntiledConfigGUI::on_update()
{
...
void PF::GmicGenericUntiledConfigGUI::open()
{
